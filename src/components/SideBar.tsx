...
const SideBar = () => {
  ...
  return (
    <div>
      ...
      <div
        className={`hidden lg:flex w-[250px] h-screen bg-white border-r border-gray-200 flex-col items-start py-8 px-6 font-bold`}
      >
        {/* Menu Items */}
        {/* Dashboard */}
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 bg-blue-600 text-white p-2 rounded-lg shadow-lg flex items-center gap-2"
      >
      ...
      {isSidebarVisible && (
        <div className="lg:hidden fixed top-0 left-0 w-[250px] h-full bg-white border-r border-gray-200 flex flex-col items-start py-14 px-6 font-bold z-40 shadow-lg">
          {/* Dashboard */}
          <div className="flex items-center gap-4 px-3 py-3 rounded-lg cursor-pointer w-full">
            <AiOutlineBarChart className="text-lg" />
            <span className="text-gray-700 text-base">Dashboard</span>
